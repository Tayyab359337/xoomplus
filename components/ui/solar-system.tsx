          ...
          {dustItems.map((dust, idx) => (
            <div
              ...
              style={{
                ...
                ["--orbit-radius" as CssVariableName]: dust.radius,
                ["--orbit-duration" as CssVariableName]: `${24 / speedMultiplier}s`,
                ["--orbit-play-state" as CssVariableName]: isPaused ? "paused" : "running",
              }}
            />
          ))}
              ...
              <React.Fragment key={orbit.id}>
                ...
                <div
                  ...
                  style={{
                    ...
                    ["--orbit-radius" as CssVariableName]: orbit.radiusClass,
                  }}
                />
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        animationPlayState: isPaused ? "paused" : "running",
                        ["--orbit-radius" as CssVariableName]: orbit.radiusClass,
                        ["--orbit-duration" as CssVariableName]: `${durationValue}s`,
                        ["--orbit-play-state" as CssVariableName]: isPaused ? "paused" : "running",
                        ["--hover-color" as CssVariableName]: item.color,
