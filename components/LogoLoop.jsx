...
/* Upstream React Bits LogoLoop (JS + CSS). */
...
const useAnimationLoop = (trackRef, targetVelocity, seqWidth, seqHeight, isHovered, hoverSpeed, isVertical, isInView) => {
  ...
  useEffect(() => {
    ...
    // Offscreen: keep last frame, stop RAF (scroll perf)
    if (!isInView) {
